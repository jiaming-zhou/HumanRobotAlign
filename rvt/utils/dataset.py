...
# demo <class 'bool'> True
# keypoint_idx <class 'int'> 0
# episode_idx <class 'int'> 28
# keypoint_frame <class 'int'> -1
# next_keypoint_frame <class 'int'> 45
# sample_frame <class 'int'> 20
# trans_action_indicies <class 'list'> 3
# rot_grip_action_indicies <class 'list'> 4
# gripper_pose <class 'numpy.ndarray'> (7,)
# lang_goal <class 'numpy.ndarray'> (1,)
# left_shoulder_rgb <class 'numpy.ndarray'> (3, 128, 128)
# left_shoulder_depth <class 'numpy.ndarray'> (1, 128, 128)
# left_shoulder_point_cloud <class 'numpy.ndarray'> (3, 128, 128)
# right_shoulder_rgb <class 'numpy.ndarray'> (3, 128, 128)
# right_shoulder_depth <class 'numpy.ndarray'> (1, 128, 128)
# right_shoulder_point_cloud <class 'numpy.ndarray'> (3, 128, 128)
# wrist_rgb <class 'numpy.ndarray'> (3, 128, 128)
# wrist_depth <class 'numpy.ndarray'> (1, 128, 128)
# wrist_point_cloud <class 'numpy.ndarray'> (3, 128, 128)
# front_rgb <class 'numpy.ndarray'> (3, 128, 128)
# front_depth <class 'numpy.ndarray'> (1, 128, 128)
# front_point_cloud <class 'numpy.ndarray'> (3, 128, 128)
# ignore_collisions <class 'numpy.ndarray'> (1,)
# low_dim_state <class 'numpy.ndarray'> (4,)
# front_camera_extrinsics <class 'numpy.ndarray'> (4, 4)
# front_camera_intrinsics <class 'numpy.ndarray'> (3, 3)
# left_shoulder_camera_extrinsics <class 'numpy.ndarray'> (4, 4)
# left_shoulder_camera_intrinsics <class 'numpy.ndarray'> (3, 3)
# right_shoulder_camera_extrinsics <class 'numpy.ndarray'> (4, 4)
# right_shoulder_camera_intrinsics <class 'numpy.ndarray'> (3, 3)
# wrist_camera_extrinsics <class 'numpy.ndarray'> (4, 4)
# wrist_camera_intrinsics <class 'numpy.ndarray'> (3, 3)
# lang_goal_embs <class 'numpy.ndarray'> (77, 512)
# action <class 'numpy.ndarray'> (8,)
# reward <class 'int'> 0
# terminal <class 'bool'> False
# timeout <class 'bool'> False